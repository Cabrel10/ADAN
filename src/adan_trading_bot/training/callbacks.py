...
class CustomTrainingInfoCallback(BaseCallback):
    ...
    def _on_training_start(self) -> None:
        ...
        console.print(Panel(
            "[cyan]💰 Capital Initial: $15.00[/cyan]\n"
    ...
    def _on_rollout_end(self) -> None:
        ...
        if self.verbose > 0 and self.rollout_count % self.check_freq == 0:
            ...
            try:
                ...
                initial_capital = 15.0  # Capital de base
                roi_pct = ((current_capital - initial_capital) / initial_capital) * 100 if current_capital > 0 else 0
